...
models = {
    ...
    "ANN (100)": MLPClassifier(hidden_layer_sizes=(100,), max_iter=400, random_state=42),
    "SVM (Linear)": SVC(kernel='linear', probability=True, random_state=42),
    "KNN (k=7)": KNeighborsClassifier(n_neighbors=7),
    "ANN (2 layers)": MLPClassifier(hidden_layer_sizes=(100, 50), max_iter=600, random_state=42),
}
...
for name, model in models.items():
    ...
    # Confusion Matrix
    cm = confusion_matrix(y_val, y_pred, labels=["Low", "Medium", "High"])
...
joblib.dump(assets, 'sales_classifier.joblib')
print("\n✅ All models trained, evaluated, and saved to sales_classifier.joblib")